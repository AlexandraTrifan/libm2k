...
//class DeviceGeneric::DeviceGeneric {
//public:
...
//	void DeviceGeneric::push(std::vector<short> const &data, unsigned int channel,
...
//	void DeviceGeneric::push(std::vector<unsigned short> const &data, unsigned int channel,
//			  bool cyclic, bool multiplex)
//	{
//		if (!m_buffer) {
//			throw_exception(EXC_RUNTIME_ERROR, "Device: Cannot push; device not buffer capable");
...
//	void DeviceGeneric::push(std::vector<double> const &data, unsigned int channel, bool cyclic = true)
//	{
//		if (!m_buffer) {
//			throw_exception(EXC_RUNTIME_ERROR, "Device: Cannot push; device not buffer capable");
//		}
...
//	std::vector<unsigned short> DeviceGeneric::getSamples(unsigned int nb_samples)
//	{
//		if (!m_buffer) {
...
//	std::vector<std::vector<double> > DeviceGeneric::getSamples(unsigned int nb_samples,
