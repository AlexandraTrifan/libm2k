...
//	virtual std::vector<std::string> scanAllAnalogIn(); //we only use it internally in the impl
//	virtual std::vector<std::string> scanAllAnalogOut();
//	virtual void scanAllPowerSupply();
//	virtual void scanAllDigital();
	virtual void scanAllDMM() = 0;

	virtual std::string getUri() = 0;

//	virtual libm2k::analog::GenericAnalogIn* getGenericAnalogIn(unsigned int);
//	virtual libm2k::analog::GenericAnalogIn* getGenericAnalogIn(std::string);
//	virtual libm2k::analog::GenericAnalogOut* getGenericAnalogOut(unsigned int);
//	virtual libm2k::analog::GenericAnalogOut* getGenericAnalogOut(std::string);
	...
	virtual libm2k::contexts::M2k* toM2k() = 0;

	virtual unsigned int getDmmCount() = 0;
//	virtual unsigned int getAnalogInCount();
//	virtual unsigned int getAnalogOutCount();
